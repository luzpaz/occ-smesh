...
public:
    SMESHGUI_CreatePolyhedralVolumeDlg( QWidget* parent = 0, const char* name = 0, SALOME_Selection* Sel = 0, bool modal = FALSE, WFlags fl = 0 );
...
private:
    ...
    QString                       myIDs;
    bool                          myOkElements ;            /* to check when elements are defined */
